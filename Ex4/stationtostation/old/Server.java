...
//-----------------------------------------------------------
        ...
        System.out.println("Got SigClient len " + sigClient.length);
        ...
        System.out.println("My sig " +ciphSign.length);
        ...
        Boolean verif = sts.verify(sigClient,rsaPubKey,rsaPubClient);
